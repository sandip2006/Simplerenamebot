...
async def start_cmd(bot, msg):
    txt="This is personal use bot 🙏. Do you want your own bot? 👇 join channel and use me💝"
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("Backup Channel", url="https://t.me/The_Happy_Hour_Hindi")
        ],[
        InlineKeyboardButton("Join Channel", url="https://t.me/The_Happy_Hour_Hindi")
    ]])
